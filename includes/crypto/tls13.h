 ...
 */
typedef int8_t (*tls13_client_certificate_verify_callback_f)(tls13_session_t*     tls13_session,
 ...
 * @return 0 on success, a negative value on failure.
 */
typedef int8_t (*tls13_client_certificates_ca_dn_list_callback_f)(tls13_session_t* tls13_session,
 ...
 * @return 0 on success, a negative value on failure.
 */
typedef int8_t (*tls13_get_psk_encryption_keys_callback_f)(tls13_session_t* tls13_session,
 ...
 *
 * This function is called when a new network connection is accepted. It initializes the TLS session for the connection and starts the handshake process. Handles application data with the provided application handler callback after the handshake is complete. This function should be called in a loop for each incoming connection.
 *
 * @param config Pointer to the TLS 1.3 configuration structure.
 * @param network_client_identifier An identifier for the network connection (e.g., a socket file descriptor).
