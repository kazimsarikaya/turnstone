...
boolean_t acpi_aml_is_null_target(acpi_aml_object_t*);
...
acpi_aml_object_t* acpi_aml_get_if_arg_local_obj(acpi_aml_parser_context_t*, acpi_aml_object_t*, boolean_t, boolean_t);
