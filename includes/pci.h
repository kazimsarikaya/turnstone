...
uint64_t  pci_get_bar_size(const pci_generic_device_t* pci_dev, uint8_t bar_no);
uint64_t  pci_get_bar_address(const pci_generic_device_t* pci_dev, uint8_t bar_no);
int8_t    pci_set_bar_address(const pci_generic_device_t* pci_dev, uint8_t bar_no, uint64_t bar_fa);
int8_t    pci_msix_configure(const pci_generic_device_t* pci_gen_dev, const pci_capability_msix_t* msix_cap);
