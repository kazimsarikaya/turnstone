...
typedef enum usb_xhci_trb_ccode_t {
    ...
    USB_XHCI_TRB_CCODE_CC_TRB_ERROR,
    ...
    USB_XHCI_TRB_CCODE_CC_INVALID_STREAM_TYPE_ERROR,
    ...
    USB_XHCI_TRB_CCODE_CC_RING_OVERRUN,
    ...
    USB_XHCI_TRB_CCODE_CC_NO_PING_RESPONSE_ERROR,
    ...
    USB_XHCI_TRB_CCODE_CC_COMMAND_ABORTED,
    ...
    USB_XHCI_TRB_CCODE_CC_SECONDARY_BANDWIDTH_ERROR,
